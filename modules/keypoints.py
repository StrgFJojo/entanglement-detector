...
def extract_keypoints(heatmap, all_keypoints, total_keypoint_num):
    ...
    heatmap_left = heatmap_with_borders[
        1 : heatmap_with_borders.shape[0] - 1,
        2 : heatmap_with_borders.shape[1],
    ]
    heatmap_right = heatmap_with_borders[
        1 : heatmap_with_borders.shape[0] - 1,
        0 : heatmap_with_borders.shape[1] - 2,
    ]
    heatmap_up = heatmap_with_borders[
        2 : heatmap_with_borders.shape[0],
        1 : heatmap_with_borders.shape[1] - 1,
    ]
    heatmap_down = heatmap_with_borders[
        0 : heatmap_with_borders.shape[0] - 2,
        1 : heatmap_with_borders.shape[1] - 1,
    ]
...
def group_keypoints(
    ...
    all_keypoints_by_type = [
        np.array(keypoints, np.float32) for keypoints in all_keypoints_by_type
    ]
    for part_id in range(len(BODY_PARTS_PAF_IDS)):
        ...
        # Compute affinity score between candidate limb vectors and
        # part affinity field.
